...
const AddForm = ({ formData, setFormData }) => {
  ...
  return (
    <div className="gap-2 shadow w-[80vw] md:w-[40vw] flex flex-col items-center text-xl text-white border rounded bg-slate-900 border-slate-700 p-2">
      ...
      <Collapse isOpened={bool}>
        ...
        >
          ...
          <div className=" flex gap-2 md:flex-row justify-between">
